...
void main() {
  ...
  final legalNameFindings = _scanForPattern(
    portfolioFiles,
    RegExp(r'legal_name'),
    'legal_name',
  );
  ...
  final documentPathFindings = _scanForPattern(
    portfolioFiles,
    RegExp(r'document_path'),
    'document_path',
  );
  ...
  final serviceRoleFindings =
      _scanForPattern(allLibFiles, RegExp(r'service_role'), 'service_role')
  ...
  group('DoD-C2: Trust legal_name/document_path/service_role scan', () {
    test(
      'no legal_name in lib/systems/portfolio/ + portfolio_provider.dart',
      () {
