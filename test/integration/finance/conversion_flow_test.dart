...
void main() {
  ...
  final FinancialRepositoryImpl financialRepository = FinancialRepositoryImpl(
    remote: financialDataSource,
  );
  ...
  test(
    'rate → estimate → execute → history fake-E2E with server semantics',
    () async {
