...
void main() {
  ...
  group('KycTierBadge status chip', () {
    testWidgets('active status shows the Active chip', (
      WidgetTester tester,
    ) async {
      await pumpBadge(tester, level('tier_1', 'active'));
    ...
    testWidgets('pending status shows the Pending chip', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('expired status shows the Expired chip', (
      WidgetTester tester,
    ) async {
  ...
  group('KycTierBadge design tokens', () {
    testWidgets('uses rounded medium corners from the theme extension', (
      ...
      final BorderRadiusGeometry radius = container.decoration is BoxDecoration
