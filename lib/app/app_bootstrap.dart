...
class AppBootstrap {
  ...
  ///
  /// [loadConfig], [initializeApi], and [initializeAuthLayer] default to the
  /// production implementations. Tests inject fakes to verify ordering and
  /// failure behavior without a live backend.
