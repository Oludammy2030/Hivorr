  ...
  Widget build(BuildContext context) {
    return switch (_state) {
      ...
      InitializationReady() => HivorrApp(
        ...
        marketplaceSearchRepository: _result!.marketplaceSearchRepository,
        marketplaceSearchProvider: _result!.marketplaceSearchProvider,
        marketplaceSearchIndex: _result!.marketplaceSearchIndex,
