...
/// A group of selectable trade-proof type chips (EP-02-11 §5.6).
///
/// Renders all [TradeProofType] values as wrapping chips. The selected chip is
...
/// target.
class TradeProofTypePicker extends StatelessWidget {
  const TradeProofTypePicker({
    super.key,
    required this.selected,
    required this.onChanged,
  });

  /// Currently selected proof type (`null` = none selected).
  final TradeProofType? selected;

  /// Selection callback.
  final ValueChanged<TradeProofType> onChanged;
